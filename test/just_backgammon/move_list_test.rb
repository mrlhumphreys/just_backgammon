...
describe JustBackgammon::MoveList do
  ...
  describe 'an ordinary move list' do
    let(:from_a) { JustBackgammon::Point.new(number: 1, pieces: [{id: 1, player_number: player}]) }
    let(:to_a) { JustBackgammon::Point.new(number: 2, pieces: []) }

    let(:from_b) { JustBackgammon::Point.new(number: 3, pieces: [{id: 2, player_number: player}]) }
  ...
  describe 'a move list a piece moving through a blot' do
    let(:from_a) { JustBackgammon::Point.new(number: 1, pieces: [{id: 1, player_number: player}]) }
    let(:to_a) { JustBackgammon::Point.new(number: 2, pieces: [{id: 2, player_number: other_player}]) }

    let(:from_b) { JustBackgammon::Point.new(number: 2, pieces: [{id: 3, player_number: other_player}]) }
    let(:to_b) { JustBackgammon::Point.new(number: 3, pieces: []) }
  ...
  describe 'a move list with an empty from' do
    ...
    let(:from_b) { JustBackgammon::Point.new(number: 3, pieces: [{id: 1, player_number: player}]) }
    let(:to_b) { JustBackgammon::Point.new(number: 4, pieces: []) }
  ...
  describe 'a move list with a combined move and an empty from' do
    ...
    let(:from_b) { JustBackgammon::Point.new(number: 2, pieces: [{id: 1, player_number: player}]) }
    let(:to_b) { JustBackgammon::Point.new(number: 3, pieces: []) }
  ...
  describe 'a move list with points owned by an opponent' do
    let(:from_a) { JustBackgammon::Point.new(number: 1, pieces: [{id: 1, player_number: other_player}]) }
    let(:to_a) { JustBackgammon::Point.new(number: 2, pieces: []) }
  ...
  describe 'a move list with a bar with pieces owned by player' do
    let(:from_a) { JustBackgammon::Bar.new(pieces: [{id: 1, player_number: player}]) }
    let(:to_a) { JustBackgammon::Point.new(number: 2, pieces: []) }
  ...
  describe 'a move list with any blocked' do
    let(:from_a) { JustBackgammon::Point.new(number: 1, pieces: [{id: 1, player_number: 1}]) }
    let(:to_a) { JustBackgammon::Point.new(number: 2, pieces: [{id: 2, player_number: 2}, {id: 3, player_number: 2}]) }
  ...
  describe 'a move list with any blocked' do
    let(:from_a) { JustBackgammon::Point.new(number: 2, pieces: [{id: 1, player_number: 1}]) }
  ...
  describe 'a move list with one bearing off' do
    ...
    let(:from_b) { JustBackgammon::Point.new(number: 24, pieces: [{id: 2, player_number: 1}]) }
  ...
  describe 'a move list with all moves from the bar' do
    let(:from_a) { JustBackgammon::Bar.new(pieces: [{id: 1, player_number: 1}, {id: 2, player_number: 1}]) }
    let(:to_a) { JustBackgammon::Point.new(number: 2, pieces: []) }

    let(:from_b) { JustBackgammon::Bar.new(pieces: [{id: 3, player_number: 1}, {id: 4, player_number: 1}]) }
    let(:to_b) { JustBackgammon::Point.new(number: 3, pieces: []) }
  ...
  describe 'absolute distance' do
    ...
    let(:from_b) { JustBackgammon::Point.new(number: 3, pieces: [{id: 2, player_number: 1}]) }
